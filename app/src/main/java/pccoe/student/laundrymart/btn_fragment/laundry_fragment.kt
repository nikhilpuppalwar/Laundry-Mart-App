...
class laundry_fragment : Fragment() {
private lateinit var binding: FragmentLaundryFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLaundryFragmentBinding.inflate(inflater,container,false)
