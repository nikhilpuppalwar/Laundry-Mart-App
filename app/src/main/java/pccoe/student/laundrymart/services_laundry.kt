...
import pccoe.student.laundrymart.databinding.ActivityServicesLaundryBinding
import pccoe.student.laundrymart.databinding.FragmentLaundryFragmentBinding
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class services_laundry : AppCompatActivity() {
    private lateinit var binding:ActivityServicesLaundryBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityServicesLaundryBinding.inflate(layoutInflater)
